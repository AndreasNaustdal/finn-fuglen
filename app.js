...
function sortertResultat(kroppsdelFarger, storrelse, beinlengde) {
  var fuglar = [
    ...
    ['Kjernebiter', 'brun', 'svart', 'brun kvit', 'oransje brun', 'liten', 'korte'],
    ['Dompap hann', 'grå', 'svart', 'rød', 'svart', 'liten', 'korte'],
    ['Dompap hunn', 'grå', 'svart', 'grå rosa', 'svart', 'liten', 'korte'],
    ['Tornirisk', 'brun', 'svart brun', 'rød kvit', 'grå brun rød', 'liten', 'korte'],
    ['Grankorsnebb hann', 'rød oransje', 'brun', 'rød oransje', 'rød oransje', 'liten', 'korte'],
    ['Grankorsnebb hun', 'gul grønn', 'brun', 'gul grønn', 'gul grønn grå', 'liten', 'korte'],
    ['Gulspurv', 'gul brun', 'gul brun', 'gul brun', 'gul brun', 'liten', 'korte'],
    ['Ravn', 'svart', 'svart', 'svart', 'svart', 'middels', 'korte'],
    ['Kråke', 'grå', 'svart', 'grå svart', 'svart', 'middels', 'korte'],
    ['Skjære', 'svart', 'svart', 'kvit', 'svart', 'middels', 'korte'],
    ...
    ['Sanglerke', 'brun', 'brun', 'kvit', 'brun', 'liten', 'korte'],
    ...
    ['Rødstrupe', 'grå brun', ' grå brun', 'rød oransje', 'grå brun', 'liten', 'korte'],
